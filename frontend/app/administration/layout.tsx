...
function AdministrationLayoutInner({ children }: { children: React.ReactNode }) {
  ...
  const sidebarHeader = (
    <div className="border-b border-white/[0.08] px-6 py-6">
      <Link href="/administration" className="flex items-start gap-3 min-w-0">
        <Image src="/eduvox-logo.png" alt="EDUVOX" width={130} height={38} className="h-10 w-auto object-contain shrink-0" />
  ...
  const mobileBarTitle = (
    <div className="flex min-w-0 items-center gap-2">
      <Image src="/eduvox-logo.png" alt="EDUVOX" width={104} height={30} className="h-8 w-auto object-contain shrink-0" />
